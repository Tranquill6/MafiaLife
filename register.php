...
<title>MafiaLife: Register</title>
        ...
        <div class="card-body">
            <form action="register.php" method="post">
                ...
                <div class="input-group form-group">
                    ...
                    <input type="text" name="alphakey" class="form-control" placeholder="Alpha Key">
                </div>

                <div class="form-group">
                    <input type="submit" name="reg_user" value="Register" class="btn btn-outline-danger float-right login_btn">
                </div>
            </form>
        </div>
    </div>
